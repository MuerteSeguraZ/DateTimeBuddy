...
console.log("\nFormat (America/New_York):", dtNY.format("YYYY-MM-DD HH:mm:ss"));
...
// --- Friendly Format ---
console.log("Friendly Format (default locale):", dt.formatFriendly());
console.log("Friendly Format (Japanese):", dt.formatFriendly("ja-JP"));
console.log("Friendly Format (French):", dt.formatFriendly("fr-FR"));
